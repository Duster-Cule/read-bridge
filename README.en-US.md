...
This repository is a fork from [WindChimeEcho/read-bridge](https://github.com/WindChimeEcho/read-bridge).

This repository makes [a few modifications to the original project](CHANGES.md) for personal use only. If you find these changes helpful, you may also deploy the project directly using this repository.

Aside from this section, no other text in the README has been modified. If you follow the deployment instructions in this document, you will still be deploying the original version of ReadBridge.
